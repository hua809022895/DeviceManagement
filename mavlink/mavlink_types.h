 ...
 * as bitfield ordering isn鈥檛 consistent between platforms. The above is intended to be for gcc on x86,
...
typedef struct __mavlink_message {
	...
	uint8_t magic;   ///< protocol magic marker，mavlink包头，即0xFE
	uint8_t len;     ///< Length of payload,包长度
	uint8_t seq;     ///< Sequence of packet,Mavlink数据包序列
	uint8_t sysid;   ///< ID of message sender system/aircraft,系统ID
	uint8_t compid;  ///< ID of the message sender component,组件ID
	uint8_t msgid;   ///< ID of message in payload,消息ID
