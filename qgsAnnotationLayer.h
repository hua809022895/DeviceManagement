...
class  QgsAnnotationLayer : public QgsMapLayer
{
    Q_OBJECT
  public:
    /* * Setting options for loading annotation layers.  * \since QGIS 3.16   */
    struct LayerOptions
    {
      /* Constructor for LayerOptions.   */
      explicit LayerOptions( const QgsCoordinateTransformContext &transformContext ):transformContext( transformContext )
      {}
	...
	void setGeometry(const QString & id,QgsPoint pos);
	void setAngle(const QString & id, QgsPoint pos);
