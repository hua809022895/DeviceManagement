...
QT_MOC_LITERAL(3, 39, 12) // "click_remove"

    },
    "layerTreeViewMenuProvider\0removelayer\0"
    "\0click_remove"
};
...
void layerTreeViewMenuProvider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->removelayer(); break;
        case 1: _t->click_remove(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (layerTreeViewMenuProvider::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&layerTreeViewMenuProvider::removelayer)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void layerTreeViewMenuProvider::removelayer()
{
