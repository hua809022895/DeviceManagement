...
public:
    ...
    void setupUi(QDialog *QgsMeasureBase)
    {
        ...
        eTotal = new QLineEdit(QgsMeasureBase);
        eTotal->setObjectName(QString::fromUtf8("eTotal"));
        eTotal->setFont(font);
        eTotal->setAlignment(Qt::AlignRight);
        eTotal->setReadOnly(true);

        mGrid->addWidget(eTotal, 4, 2, 1, 1);
        ...
        totalDistanceLabel->setBuddy(eTotal);
#endif // QT_NO_SHORTCUT
        QWidget::setTabOrder(mTable, eTotal);
    ...
    {
        QgsMeasureBase->setWindowTitle(QApplication::translate("QgsMeasureBase", "\346\265\213\351\207\217", nullptr));
        ...
        totalDistanceLabel->setText(QApplication::translate("QgsMeasureBase", "\345\220\210\350\256\241", nullptr));
        totalHorizontalDistanceLabel->setText(QApplication::translate("QgsMeasureBase", "\346\260\264\345\271\263\350\267\235\347\246\273", nullptr));
        mEllipsoidal->setText(QApplication::translate("QgsMeasureBase", "\347\220\203\351\235\242", nullptr));
        mCartesian->setText(QApplication::translate("QgsMeasureBase", "\345\271\263\351\235\242", nullptr));
        groupBox->setTitle(QApplication::translate("QgsMeasureBase", "\346\217\220\347\244\272", nullptr));
