...
QT_INIT_METAOBJECT const QMetaObject QgsMapToolRotateFeature::staticMetaObject = { {
    &QgsMapToolEdit::staticMetaObject,
    qt_meta_stringdata_QgsMapToolRotateFeature.data,
    qt_meta_data_QgsMapToolRotateFeature,
    qt_static_metacall,
    nullptr,
    nullptr
} };
