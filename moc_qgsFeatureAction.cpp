...
QT_MOC_LITERAL(4, 45, 15), // "viewFeatureForm"
QT_MOC_LITERAL(5, 61, 13), // "QgsHighlight*"
QT_MOC_LITERAL(6, 75, 1), // "h"
QT_MOC_LITERAL(7, 77, 11), // "editFeature"
QT_MOC_LITERAL(8, 89, 9), // "showModal"
QT_MOC_LITERAL(9, 99, 10), // "addFeature"
QT_MOC_LITERAL(10, 110, 15), // "QgsAttributeMap"
QT_MOC_LITERAL(11, 126, 17), // "defaultAttributes"
QT_MOC_LITERAL(12, 144, 26), // "QgsExpressionContextScope*"
QT_MOC_LITERAL(13, 171, 5), // "scope"
QT_MOC_LITERAL(14, 177, 25), // "setForceSuppressFormPopup"
QT_MOC_LITERAL(15, 203, 5), // "force"
QT_MOC_LITERAL(16, 209, 7), // "feature"
QT_MOC_LITERAL(17, 217, 10), // "QgsFeature"
QT_MOC_LITERAL(18, 228, 14) // "onFeatureSaved"

    },
    "QgsFeatureAction\0addFeatureFinished\0"
    "\0execute\0viewFeatureForm\0QgsHighlight*\0"
    "h\0editFeature\0showModal\0addFeature\0"
    "QgsAttributeMap\0defaultAttributes\0"
...
static const uint qt_meta_data_QgsFeatureAction[] = {
 ...
 // slots: name, argc, parameters, tag, flags
       ...
       7,    0,   88,    2, 0x2a /* Public | MethodCloned */,
       9,    3,   89,    2, 0x0a /* Public */,
       9,    2,   96,    2, 0x2a /* Public | MethodCloned */,
 ...
 // slots: parameters
    ...
    QMetaType::Bool,
    QMetaType::Bool, 0x80000000 | 10, QMetaType::Bool, 0x80000000 | 12,   11,    8,   13,
    QMetaType::Bool, 0x80000000 | 10, QMetaType::Bool,   11,    8,
...
void QgsFeatureAction::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: { bool _r = _t->viewFeatureForm((*reinterpret_cast< QgsHighlight*(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 3: { bool _r = _t->viewFeatureForm();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 4: { bool _r = _t->editFeature((*reinterpret_cast< bool(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 5: { bool _r = _t->editFeature();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 6: { bool _r = _t->addFeature((*reinterpret_cast< const QgsAttributeMap(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2])),(*reinterpret_cast< QgsExpressionContextScope*(*)>(_a[3])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 7: { bool _r = _t->addFeature((*reinterpret_cast< const QgsAttributeMap(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 8: { bool _r = _t->addFeature((*reinterpret_cast< const QgsAttributeMap(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 9: { bool _r = _t->addFeature();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 10: _t->setForceSuppressFormPopup((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 11: { QgsFeature _r = _t->feature();
            if (_a[0]) *reinterpret_cast< QgsFeature*>(_a[0]) = std::move(_r); }  break;
        case 12: _t->onFeatureSaved((*reinterpret_cast< const QgsFeature(*)>(_a[1]))); break;
        default: ;
        }
