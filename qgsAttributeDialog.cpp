...
void QgsAttributeDialog::accept()
{
  ...
  if ( didSave )
  {
//      QgsFeature *fea = const_cast<QgsFeature *>(feature()) ;
//      QString pos = "";
//      QList<QgsFilterLineEdit *> widgets1 = mAttributeForm->findChildren<QgsFilterLineEdit *>();
...
//          {
//              fea->setGeometry(geo);
//              mAttributeForm->layer()->updateFeature(*fea);
//              mAttributeForm->layer()->commitChanges();
//              mAttributeForm->layer()->triggerRepaint();
