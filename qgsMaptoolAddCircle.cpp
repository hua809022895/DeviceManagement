...
QgsMapToolAddCircle::QgsMapToolAddCircle( QgsMapToolCapture *parentTool, QgsMapCanvas *canvas, CaptureMode mode )
  : QgsMapToolCapture( canvas, MainWindow::instance()->cadDockWidget(), mode )
...
//  }
  ...
  //QgsVectorLayer *vLayer = static_cast<QgsVectorLayer *>(  MainWindow::instance()->activeLayer() );
 // if ( vLayer )
    mLayerType = QgsWkbTypes::PolygonGeometry;
}
