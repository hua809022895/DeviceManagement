...
#ifndef QGSMAPCANVASANNOTATIONITEM3_H
#define QGSMAPCANVASANNOTATIONITEM3_H

#include "qgsmapcanvasitem.h"
#include "qgis_gui.h"

class QgsAirAnnotation;

class QgsMapCanvasAnnotationItem3: public QObject, public QgsMapCanvasItem
{
    Q_OBJECT
  public:
     ...
     */
    QgsMapCanvasAnnotationItem3(QgsAirAnnotation *annotation SIP_TRANSFER, QgsMapCanvas *mapCanvas SIP_TRANSFERTHIS );

    /**
     * Returns the item's annotation.
     * \note not available in Python bindings
     */
    const QgsAirAnnotation *annotation() const { return mAnnotation; } SIP_SKIP
	QgsAirAnnotation *annotation() { return mAnnotation; }
  ...
  private:
	...
	QgsAirAnnotation *mAnnotation = nullptr;
