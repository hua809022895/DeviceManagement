...
class QgsDistanceArea
{
  public:
     ...
     * \see convertLengthMeasurement()  * \since QGIS 2.14 */
     ...
     * \see splitGeometryAtAntimeridian()  * \since QGIS 3.6   */
  ...
  private:
    ...
    //椭球体缩写 ellipsoid acronym (from table tbl_ellipsoids)
    QString mEllipsoid;

    //椭球体参数， ellipsoid parameters
