...
struct qt_meta_stringdata_QgsMeasureTool_t {
    QByteArrayData data[3];
    char stringdata0[31];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QgsMeasureTool_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QgsMeasureTool_t qt_meta_stringdata_QgsMeasureTool = {
    {
QT_MOC_LITERAL(0, 0, 14), // "QgsMeasureTool"
QT_MOC_LITERAL(1, 15, 14), // "updateSettings"
QT_MOC_LITERAL(2, 30, 0) // ""

    },
    "QgsMeasureTool\0updateSettings\0"
};
...
void QgsMeasureTool::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QgsMeasureTool *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QgsMeasureTool::staticMetaObject = { {
    &QgsMapTool::staticMetaObject,
    qt_meta_stringdata_QgsMeasureTool.data,
    qt_meta_data_QgsMeasureTool,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *QgsMeasureTool::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QgsMeasureTool.stringdata0))
